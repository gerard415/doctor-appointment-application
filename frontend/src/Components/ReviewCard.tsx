        ...
        <div className='flex justify-between'>
            <div className='flex space-x-2'>
                ...
                <div className='text-[11px] text-gray-500 '>
                    <p className='text-indigo-400 font-bold text-[12px] ' >Ahmed Ali</p>
                    <p>June 27, 2023</p>
                    <p className='pt-3'>Good doctor, highly recommend</p>
                </div>
            </div>
            <div className='flex justify-end'>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" strokeWidth={0} stroke="currentColor" className="w-6 h-4 fill-blue-600">
