...
const DoctorProfileLayout = () => {
    ...
    return (
            <div>
                <div className=' galaxyfold:px-7 middle:px-10 lg:px-24 md:flex md:space-x-10  justify-center  md:space-y-0 '>
                    <div className='h-[300px] w-[250px] md:flex flex-col items-center justify-between hidden shadow p-4'>
